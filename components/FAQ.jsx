...
const items = [
  {
    ...
    text: " A: At XYZ Company, we pride ourselves on innovation and cutting-edgetechnology. Our products are crafted with a perfect blend of creativity and functionality, setting them apart from the competition. We constantly strive to push the boundaries of what's possible todeliver a truly exceptional user experience.",
  },
  {
    value: "b",
    title: "Q: How does XYZ Company contribute to sustainability and environmental conservation?",
  ...
  {
    value: "c",
    title: "Q: What kind of support can customers expect from XYZ Company's customer service team?",
  ...
  {
    value: "e",
    title: "Q: Can you tell us about XYZ Company's commitment to community involvement?",
